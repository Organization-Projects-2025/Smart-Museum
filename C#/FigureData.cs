    ...
    static MuseumData()
    {
        ...
        Figures = new Dictionary<int, FigureDef>
        {
            ...
            { 0, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/0_cleopatra/portrait.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 8000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/0_cleopatra/alexandria.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        Content    = "Cleopatra ruled from Alexandria — one of the ancient world's greatest cities. She was renowned for her intellect, multilingualism (she spoke nine languages), and political mastery.",
                        DurationMs = 8000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/0_cleopatra/rome_alliance.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            { 1, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/1_nefertiti/bust.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 8000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/1_nefertiti/amarna_city.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        Content    = "Nefertiti's famous painted limestone bust — discovered in 1912 in Amarna — is one of the most recognised works of ancient art. Her name in Egyptian means \"The Beautiful One Has Come.\"",
                        DurationMs = 8000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            { 2, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/2_tutankhamun/golden_mask.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/2_tutankhamun/tomb_discovery.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            { 3, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/3_ramesses/abu_simbel.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 8000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/3_ramesses/battle_kadesh.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        Content    = "He led the Egyptian army at the Battle of Kadesh against the Hittite Empire — the earliest recorded battle in history. Although the battle was inconclusive, Ramesses portrayed it as a great victory in temple reliefs across Egypt.",
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            { 4, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/4_hatshepsut/temple.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/4_hatshepsut/punt_expedition.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        Content    = "She launched a famous trading expedition to the Land of Punt, returning with gold, ivory, myrrh trees, and exotic animals. She commemorated this voyage in stunning reliefs at her mortuary temple in Deir el-Bahari.",
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            { 5, new FigureDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/5_akhenaten/colossal_statue.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/figures/5_akhenaten/amarna_art.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
        ...
        Relationships = new List<RelationshipDef>
        {
            ...
            new RelationshipDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/1_5_nefertiti_akhenaten/royal_couple_relief.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/1_5_nefertiti_akhenaten/family_scene.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            new RelationshipDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/2_5_tutankhamun_akhenaten/amarna_succession.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                    ...
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/2_5_tutankhamun_akhenaten/restoration_stele.jpg",
                        DurationMs = 6000 },
                }
            },
            ...
            new RelationshipDef
            {
                ...
                Slides          = new List<ContentSlide>
                {
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/1_2_nefertiti_tutankhamun/amarna_interlude.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            new RelationshipDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/0_1_cleopatra_nefertiti/two_queens.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
                    ...
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 10000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/0_1_cleopatra_nefertiti/legacy_art.jpg",
                        DurationMs = 6000 },
                }
            },
            ...
            new RelationshipDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/0_3_cleopatra_ramesses/egypt_timeline.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            new RelationshipDef
            {
                ...
                {
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/4_3_hatshepsut_ramesses/monuments.jpg",
                        DurationMs = 6000 },
                    new ContentSlide { Type = ContentType.Text,
            ...
            new RelationshipDef
            {
                ...
                Slides          = new List<ContentSlide>
                {
                    ...
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 9000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/5_4_akhenaten_hatshepsut/erased_names.jpg",
                        DurationMs = 6000 },
                }
            },
            ...
            new RelationshipDef
            {
                ...
                Slides          = new List<ContentSlide>
                {
                    ...
                    new ContentSlide { Type = ContentType.Text,
                        ...
                        DurationMs = 10000 },
                    new ContentSlide { Type = ContentType.Image,
                        Content    = "content/relationships/3_2_ramesses_tutankhamun/new_kingdom.jpg",
                        DurationMs = 6000 },
                }
            },
        };
